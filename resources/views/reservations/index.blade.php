                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($reservation->reserved_datetime > now())
                                        <a href="#" class="link-secondary" data-bs-toggle="modal" data-bs-target="#cancelReservationModal" data-reservation-id="{{ $reservation->id }}" data-shop-name="{{ $reservation->shop->name }}">キャンセル</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
